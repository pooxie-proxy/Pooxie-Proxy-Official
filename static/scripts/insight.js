document.addEventListener('DOMContentLoaded', () => {
  const appsList = [
    {
      name: "APPS ARE NOT WORKING",
      link: "https://www.google.com/search?q=slope+intercept+form&rlz=1C5CHFA_enUS944US944&oq=slope+intercept+form&gs_lcrp=EgZjaHJvbWUyCQgAEEUYORiABDIHCAEQABiABDIHCAIQABiABDIHCAMQABiABDIHCAQQABiABDIHCAUQABiABDIHCAYQABiABDIHCAcQABiABDIHCAgQABiABDIHCAkQABiABNIBCDUwMTlqMGo3qAIAsAIA&sourceid=chrome&ie=UTF-8",
      image: "https://cdn0.iconfinder.com/data/icons/shift-interfaces/32/Error-512.png",
      categories: ["all", "media"],
      error: true,
      say: "Apps are not working, Please try again when we have fixed them."
    },
