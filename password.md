...
- Instead of putting users and passwords in the code, do these two lines: `const accountPass = secrets.accountPass;` and `"YOUR_USERNAME_HERE":accountPass` and the github secret name being `accountPass`
